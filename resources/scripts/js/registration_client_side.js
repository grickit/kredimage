...
function birthYearValidate() {
  ...
  if (year_regex.test(birthyear) == false) {
    ...
    document.getElementById("e_birth_year").innerHTML = "I don't think you were born " + difference + " years ago."
    document.getElementById("e_birth_year").className = "error";
    return false
  }
  else if (difference < 0) {
    document.getElementById("e_birth_year").innerHTML = "I don't think you're a time traveler from the future."
    document.getElementById("e_birth_year").className = "error";
    return false
  }
  else {
